 ...
 *                  The first argument contains the Error object in case of an error, otherwise null.
 *                  The second argument is either of type Object - in case of insert it returnes the inserted document with an _id
 *                  , or type Int - in case of update it returns 1 when insterted succesfully.
 *
...
//			console.log("All found docs from collection from findAll: ", docs);
			callback(err, docs);
		});
};
...
/**
 * This is a utility to query all available mongodb databases.
