...
MongoDB.prototype.disconnect = function (callback) {
	...
	self._mongooseProvider.connection.close(function () {
		self._connection = null;
		return callback();
	});
	
	// NB! this function of mongoose loops through all active connecitons
	...
	// When the connection is disconnected - ask Bart
	self._mongooseProvider.connection.on('disconnected', function () {
